...
template <
    typename index_t,
    typename value_t>
__global__ void shfl_FullDTW_255( // was DTW_fast_256_shuffle_kernel_no_shared_memory
    value_t *Subject,
    value_t *Dist,
    index_t num_entries,
    index_t num_features)
{
    ...
    const index_t blid = blockIdx.x; // Q: which series
    const index_t thid = threadIdx.x; // Q: among 32 (why 32?)
